...
// import { Plus, Pencil, Trash2, Phone, Clock, ShoppingCart, Coins, Users2 } from 'lucide-react';
// import { Button } from '@/components/ui/button';
// import { Badge } from '@/components/ui/badge';
// import { ScrollArea } from '@/components/ui/scroll-area';
// import { Tooltip, TooltipContent, TooltipTrigger } from '@/components/ui/tooltip';
// import { TicketBuyer, TicketMatch } from '@/types/ticket.types';
...
//   buyers: TicketBuyer[];
//   matches: TicketMatch[];
//   canEdit: boolean;   // false for SELLER role
//   canDelete: boolean;
//   onAdd: () => void;
//   onEdit: (buyer: TicketBuyer) => void;
//   onDelete: (buyer: TicketBuyer) => void;
// }
...
//   const matchedBuyerIds = new Set(matches.map((m) => m.buyer.id));
...
//             <p className="text-xs text-muted-foreground">{buyers.length} requests</p>
//           </div>
//         </div>
...
//               <p className="text-sm font-medium text-muted-foreground">No buyer requests yet</p>
//               {canEdit && (
...
//           ) : (
//             buyers.map((buyer) => {
//               const isMatched = matchedBuyerIds.has(buyer.id);
...
//                       : 'border-border bg-background hover:border-violet-300 dark:hover:border-violet-700'
//                   )}
...
//                         <span className="font-medium text-foreground">{buyer.fromCity}</span>
//                         <span>→</span>
//                         <span className="font-medium text-foreground">{buyer.toCity}</span>
//                       </div>
//                     </div>
...
//                       ₹{buyer.budgetPerSeat.toLocaleString()}
//                     </span>
//                   </div>
...
//                             Date: {format(new Date(buyer.travelDate), 'dd MMM yyyy')}
//                           </div>
//                           {buyer.notes && (
